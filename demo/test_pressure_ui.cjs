...
h.run("renderResult({execute_seconds:0.02},{mode:'fresh_query',batch_preparation:{reused_batches:3}})");assert(h.nodes.get('summary').innerHTML.includes('Fresh query over prepared records · 3 batches reused.'));
