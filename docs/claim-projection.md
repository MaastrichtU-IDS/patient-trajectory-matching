...
This completes a bounded prototype for information-object claim descriptions and policy-controlled projection. It does not migrate the MIMIC record pipeline, accept patient-local clocks, add measurement timestamps, implement clinical conflict adjudication or close the original 18 full formal mapping obligations. Those are separately versioned extensions. Clinical mapping review and the broader upstream pattern adoption remain open.
