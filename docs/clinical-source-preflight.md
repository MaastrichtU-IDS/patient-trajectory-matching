...
The subsequent [indexed source-window implementation](indexed-source-windows.md) now addresses the source selection step and exports individual pending batches. Its public-demo report retains every anchor and identifies the remaining oversized windows. Clinical review, complete batch execution and a binding-preserving resolution of those windows remain pending.
