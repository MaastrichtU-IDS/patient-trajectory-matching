...
```sh
python -m unittest app.test_journey_http
...
The implementation remains a bounded synthetic research prototype. General multi-event authoring, validated patient similarity, clinical outcomes, real-data extraction and target-cluster operation are separate work.
