...
6. Run [MIMIC inputevents staging](mimic-inputevents-staging.md) and review its reconciliation and blocked handoff. Implement patient-local clock conversion and reviewed clinical mappings before matcher integration.
