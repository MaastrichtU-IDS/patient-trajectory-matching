...
The separate [checked Rust semantic-support profile](../semantic-support.md) now supplies ground class entailment and consistency evidence for a restricted generated rule module. It does not widen this mapping harness's common selector or resolve full SULO/import and identity obligations.
